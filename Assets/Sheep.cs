...
public class Sheep : MonoBehaviour
{
    ...
    private void HitByHay()
    {
        ...
        GameObject newHeart = Instantiate(heartPrefab, transform.position + new Vector3(0, heartOffset, 0), Quaternion.identity);
        newHeart.transform.Rotate(-90, -45, 0);
    ...
    private void Drop()
    {
        ...
        GameStateManager.Instance.DroppedSheep(transform.GetInstanceID());
        sheepSpawner.RemoveSheepFromList(gameObject);
